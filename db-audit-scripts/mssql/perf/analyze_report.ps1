...
# Cover ----------------------------------------------------------------------
$cover = @"
<section class="cover"><div class="cover-content"><h1>SQL Server Performance Audit Report</h1><div class="sub">$(if ($Customer) { Esc $Customer } else { '' })</div><div class="meta"><strong>Server:</strong> $(if ($ServerName) { Esc $ServerName } else { '(unspecified)' }) &nbsp;&middot;&nbsp; <strong>$dbCount</strong> databases analyzed</div><div class="date">$now</div></div></section>
"@

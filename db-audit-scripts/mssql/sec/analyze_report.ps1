...
.cover{page-break-after:always;box-sizing:border-box;padding:40px;background:linear-gradient(135deg,#8e44ad 0%,#6f3690 100%);color:white;min-height:230mm;break-after:page;overflow:hidden}

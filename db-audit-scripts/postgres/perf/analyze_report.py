...
def main() -> int:
    ...
    ap.add_argument('--out',      default='', help='Output HTML path (default: <report_dir>/postgres_perf_analysis.html)')
    args = ap.parse_args()
    ...
    out = Path(args.out) if args.out else (report_dir / 'postgres_perf_analysis.html')

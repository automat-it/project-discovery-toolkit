...
<#
.SYNOPSIS
    Run the SQL Server security audit against every user database on an
...
.EXAMPLE
    # SQL Server auth, only prod databases
    $env:SQLCMDPASSWORD = "s3cr3t"
    .\run_all_databases.ps1 -Server "sql01,1433" -User auditor -IncludeLike "prod_%"
#>
...
$summary.Add("Category:    sec (all databases)")

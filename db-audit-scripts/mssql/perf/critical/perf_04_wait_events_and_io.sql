...
-- ---------------------------------------------------------------------------
-- Per-database file I/O totals. sys.master_files does not exist on Azure
    ...
    BEGIN TRY
        EXEC sp_executesql N'
            SELECT TOP 50
                ...
                -- The view exposes a generic io_stall column (read+write),
                -- not io_stall_ms. Rename for clarity.
